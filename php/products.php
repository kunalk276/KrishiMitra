...
<thead>
    ...
    <input name="proid" type="number" value="<?php echo $row['prodid'];?>" readonly required style="visibility:hidden;">
        ...
        <td><div class="input-container"><input type="number" name="quantity" required></div></td>
        <td><div class="input-container"><input type="number" name="price" step="0.01" required></div></td>

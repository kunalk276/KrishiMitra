	...
	<div class="container-fluid footer">
		...
		<div class="row contact text-center text-md-left">
	        ...
	        <div class="col-md-3 pl-3 pt-4">
	          <h6><i class="fa fa-phone mr-3" aria-hidden="true"></i>9325520672</h6>
	          <h6><i class="fa fa-envelope mr-3 mt-4" aria-hidden="true"></i>kunal@gmail.com</h6>
	          <h6><i class="fa fa-home fa-lg mr-3 mt-4" aria-hidden="true"></i>Asm IBMR, Chinchwad, Pune</h6>
	        </div>
	        <div class="col-md-3">
	    ...
	    <div class="row py-2 mt-3" style="background-color: #3797a4; font-weight: 600;">
	    	<div class="col-lg-12 text-center">
	    		© 2025 Copyright <a href="#" style="text-decoration: none; color: inherit">Krishi Mitra</a>
	    	</div>
        </div>
	</div>
